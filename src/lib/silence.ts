...
export function silentAudio(format: AudioFormat): Buffer {
  switch (format) {
    case "wav":
      return silentWav();
    case "pcm":
      return Buffer.alloc(24000 * 2 * 0.2 | 0); // 裸 PCM 静音，~0.2s 16bit 24kHz mono
    case "mp3":
    case "ogg_opus":
    default:
